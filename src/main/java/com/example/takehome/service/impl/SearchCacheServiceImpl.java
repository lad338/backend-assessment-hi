...
public class SearchCacheServiceImpl implements SearchCacheService {
  ...
  @Cacheable(value = COUNTRY, key = "#countryCode", unless = "#result == null")
  public String getContinentCodeByCountryCode(String countryCode) {
    ...
    return redisCountryTemplate.opsForValue().get(COUNTRY + CONCATENATOR + countryCode);
  }

  @Cacheable(value = CONTINENT, key = "#continentCode", unless = "#result == null")
  public CacheContinent getContinentByContinentCode(String continentCode) {
    ...
    return redisContinentTemplate.opsForValue().get(CONTINENT + CONCATENATOR + continentCode);
  }
}
